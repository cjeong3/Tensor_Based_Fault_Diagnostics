...
% #########################################################################
% Title: (PHASE2) Benchmark I - CP-based Method with rank 1 
...
%                 end 
                ...
                if Iter~=1
                    ...
                    zeta1=norm(U_old-U_new,2);
                    zeta2=norm(V_old-V_new,2);
                    zeta3=norm(W_old-W_new,2);
    ...
    Bout = BetaCell{f,rr};
    negloglik_penalty_out = negloglik_penalty_cell{f,rr};
    U_record_out = U_record_cell{f,rr};
    V_record_out = V_record_cell{f,rr};
    W_record_out = W_record_cell{f,rr};
    b_record_out = b_record_cell{f,rr};    
    AICc_rslt = [AICc_rslt; M];
